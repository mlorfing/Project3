...
public class BangFX extends Application {
    ...
    public void dynamiteAction(){
        if(dynamiteCount > 3){
            ...
            System.out.println("Turn ended due to dynamite explosion.");
        }
        dynamiteCount++;
    }
    ...
    public void barrowAction(){
        System.out.println(current.arrows);
        if(current.arrows == 0) {
            Random rand = new Random();
            int pick = (rand.nextInt(100000000)%players.getValue());
